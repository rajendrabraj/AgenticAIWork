...
async def main() -> None:
    ...
    agent1 = AssistantAgent("assistant1",model_client=model_client,system_message="You are a writer and provide logical output with example and use cases ,write well under 50 words")
    agent2 = AssistantAgent(
        "assistant2",model_client=model_client,
        system_message="You are an editor, provide critical feedback with logical reasoning under 50 words. Respond with 'APPROVE' if the text addresses all feedbacks."
    ...
    agent3 = AssistantAgent(
        "assistant3", model_client=model_client, system_message="You are responsible for producing imaginative ideas with examples.",
    )
