...
async def main() -> None:
    ...
    agent1 = AssistantAgent("assistant1",model_client=model_client,system_message="You are a writer ,write well under 150 words")
    ...
    society_of_mind_agent = SocietyOfMindAgent("society_of_mind",
            ...
            response_prompt="Output a standalone response to the original request under 150 words , without mentioning any of the intermediate discussions"
        )
    
    
    agent3 = AssistantAgent(
        "assistant3", model_client=model_client, system_message="You are responsible for producing imaginative ideas."
    )
    ...
    stream = team.run_stream(task="Write a short story about Agentic AI under 150 words..")
